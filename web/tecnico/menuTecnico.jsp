            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <p class="card-category">Evaluacion En Terreno</p>
                  <h3 class="card-title" href="./registroEvaluacionesTerreno.jsp"><a href="./registroEvaluacionesTerreno.jsp">Entrar</a></h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                  </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <p class="card-category">Evaluacion Personal</p>
                  <h3 class="card-title"><a href="./registroEvaluacionesPersonal.jsp">Entra</a></h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                  </div>
