 ...
 * @author Diego
 */
@WebServlet(name = "ServRegistroEvaluacionTecnico", urlPatterns = {"/ServRegistroEvaluacionTecnico"})
public class ServRegistroEvaluacionTecnico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            String empresa = request.getParameter("sRutEmpresa");
