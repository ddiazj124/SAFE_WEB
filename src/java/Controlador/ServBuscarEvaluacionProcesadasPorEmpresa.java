 ...
 * @author Diego
 */
@WebServlet(name = "ServBuscarEvaluacionProcesadasPorEmpresa", urlPatterns = {"/ServBuscarEvaluacionProcesadasPorEmpresa"})
public class ServBuscarEvaluacionProcesadasPorEmpresa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            ListaEvaluaciones = dao.listLiteProcesadaPersona(idEmpresaCmb);
