 ...
 * @author Diego
 */
@WebServlet(name = "ServAdministrarExamenMedico", urlPatterns = {"/ServAdministrarExamenMedico"})
public class ServAdministrarExamenMedico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String fechaExamen = request.getParameter("txtFechaExamen");
