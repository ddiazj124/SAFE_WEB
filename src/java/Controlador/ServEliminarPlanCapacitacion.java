...
@WebServlet(name = "ServEliminarPlanCapacitacion", urlPatterns = {"/ServEliminarPlanCapacitacion"})
public class ServEliminarPlanCapacitacion extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String idPlanCapacitacionEliminar = request.getParameter("idPlanCapacitacionEliminar");
                         
        try{             
            PlanCapacitacionDAO dao         = new PlanCapacitacionDAO();
            PlanCapacitacionVO  vo          = new PlanCapacitacionVO();
                        
            vo.setId_plan(Integer.parseInt(idPlanCapacitacionEliminar));
            
            salida = dao.delete(vo.getId_plan());           
