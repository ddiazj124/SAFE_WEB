 ...
 * @author Diego
 */
@WebServlet(name = "ServBuscarEvaluacionPorEmpresa", urlPatterns = {"/ServBuscarEvaluacionPorEmpresa"})
public class ServBuscarEvaluacionPorEmpresa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            ListaEvaluaciones = dao.listLite(idEmpresaCmb);
