...
public class DAOEvaluacion {
    ...
    private static String sql_EvaluacionesPregunta = "SELECT E.TITULO,E.FECHA_EVAL,E.DESCRIPCION,EMP.RAZON_SOCIAL FROM EVALUACION E JOIN EMPRESA EMP ON (emp.rut_empresa = e.rut_empresa) where e.id_ev = ? order by id_ev";
